                ...
                <div className='py-20 h-full w-full flex justify-center'>
                    ...
                    <div className="h-full w-10/12 flex justify-between">
                        ...
                        <div className='flex-1 flex flex-col gap-8'>
                            ...
                            <span className="text-[20px] text-[#333]">Price: <span className='text-orange-500 ml-2'>R${product?.price}</span></span>
...
export async function getServerSideProps(ctx) {
    ...
    const { data: product } = await axios.get(`https://bert-look-next-js.vercel.app/api/products/${id}`)
